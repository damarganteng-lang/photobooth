...
function updateCollage() {
    ...
    if (selectedBgImage) {
        ...
        switch (layout) {
            case 'grid':
                collageContainer.style.backgroundsize = '20%';
                collageContainer.style.backgroundPosition = 'center';
                collageContainer.style.backgroundRepeat = 'repeat';
                break;
            case 'stack':
                collageContainer.style.backgroundSize = '15%';
                collageContainer.style.backgroundPosition = 'center';
                collageContainer.style.backgroundRepeat = 'repeat';
                break;
            case 'polaroid':
                collageContainer.style.backgroundSize = 'auto 100%';
                collageContainer.style.backgroundPosition = 'left top';
                collageContainer.style.backgroundRepeat = 'repeat-x';
                break;
            case 'filmstrip':
                collageContainer.style.backgroundSize = '12%';
                collageContainer.style.backgroundPosition = 'center';
                ollageContainer.style.backgroundRepeat = 'repeat';
                break;
